...
public class WikiSearch {
    ...
    private static JedisIndex index;
	...
	public WikiSearch or(WikiSearch that) {
        Map<String, Integer> ret = new HashMap<String, Integer>(map);
        for (String url : that.map.keySet()) {
            ret.put(url, totalRelevance(getRelevance(url),
	...
	public List<Entry<String, Integer>> sort() {
        List<Entry<String, Integer>> ret = new ArrayList<>(map.entrySet());
